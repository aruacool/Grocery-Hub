    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 bg-surface-900 overflow-hidden">
      ...
      <div className="relative z-10 bg-surface-800/70 backdrop-blur-xl rounded-2xl p-8 max-w-sm w-full text-center shadow-2xl border border-surface-600/30">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-medium py-3 px-6 rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg cursor-pointer mb-3"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white hover:bg-surface-100 text-surface-900 font-medium py-3 px-6 rounded-xl transition-all hover:scale-[1.02] hover:shadow-lg cursor-pointer"
        >
